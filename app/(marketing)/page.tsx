            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-16 lg:gap-24 items-start">
              ...
              <div className="lg:sticky lg:top-32">
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-inter)" }}
                >
                  You spend 30 minutes on a proposal. You make it personal. You
                  try to stand out. And then&nbsp;—&nbsp;nothing. No reply. No
                  view. The job closes.
                </p>
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-instrument-serif)" }}
                >
                  Sound familiar? Here&rsquo;s what&rsquo;s actually going
                  wrong:
                </p>
              </div>
